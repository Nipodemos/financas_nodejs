...
export const getTodosUsuarios: RequestHandler = async (_, res) => {
...
export const criarUsuario: RequestHandler = async (req, res) => {
...
export const alterarUsuario: RequestHandler = async (req, res) => {
  const bodySchema = z.object({
    email: z.string().email(),
...
export const excluirUsuario: RequestHandler = async (req, res) => {
